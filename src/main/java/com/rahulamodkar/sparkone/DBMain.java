...
public class DBMain implements Serializable {

    private static final org.apache.log4j.Logger LOGGER = org.apache.log4j.Logger.getLogger(DBMain.class);
    ...
    public static void main(String[] args) {
        ...
        DataFrame tableRows = jdbcDF.filter(column.contains("TestWebpage99"));
        /*try {
        	Thread.sleep(60000);
        } catch(Exception ex) {
